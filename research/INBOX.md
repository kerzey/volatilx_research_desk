...
- [x] FMP API key granted to the desk (Haci, 2026-09-15) → `FMP_API_KEY` loads via desk_env; CLAUDE.md rule 1 line for Haci to add (guarded file); scope and knowledge-time rules in research/data/DATA_NOTES.md 'External source: FMP'; steward check on H-022's insider-history blocker noted in DEFERRED.md
