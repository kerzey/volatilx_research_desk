...
| EN-002 | behaviour | BRIEF_WRITTEN | Q002 (2026-10-12) | FAILED:picks=578 vs frozen 579 (Section 8a), TJX 2026-06-11 dropped by tier_of<80 gate -- see VERIFY_EN-002.md | Speed-to-target on the report card: sessions to first touch of L1/L2/L3 from the next open, shown next to the distance-matched control. Source: EXPLORE_001 §E, H-065. |
